...
const CONNECTION_URL = `mongodb+srv://himanshudigrase:J097772H@telehealth.ajziuro.mongodb.net/?retryWrites=true&w=majority`; 
// `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@ks1.o35j3.mongodb.net/MajorProject?retryWrites=true&w=majority`;
